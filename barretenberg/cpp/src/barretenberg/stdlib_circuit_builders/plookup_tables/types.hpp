...
enum BasicTableId {
    ...
    // 12-bit fixed-base tables (4096 entries each)
    BN254_XLO_12BIT_BASIC,
    BN254_XHI_12BIT_BASIC,
    BN254_YLO_12BIT_BASIC,
    BN254_YHI_12BIT_BASIC,
    BN254_XYPRIME_12BIT_BASIC,
    BN254_XLO_ENDO_12BIT_BASIC,
    BN254_XHI_ENDO_12BIT_BASIC,
    BN254_XYPRIME_ENDO_12BIT_BASIC,
    SECP256K1_XLO_BASIC,
    SECP256K1_XHI_BASIC,
    SECP256K1_YLO_BASIC,
    SECP256K1_YHI_BASIC,
...
enum MultiTableId {
    ...
    BN254_XHI_ENDO,
    BN254_XYPRIME_ENDO,
    // 12-bit fixed-base multi tables (4096 entries each)
    BN254_XLO_12BIT,
    BN254_XHI_12BIT,
    BN254_YLO_12BIT,
    BN254_YHI_12BIT,
    BN254_XYPRIME_12BIT,
    BN254_XLO_ENDO_12BIT,
    BN254_XHI_ENDO_12BIT,
    BN254_XYPRIME_ENDO_12BIT,
    SECP256K1_XLO,
    SECP256K1_XHI,
    SECP256K1_YLO,
    SECP256K1_YHI,
